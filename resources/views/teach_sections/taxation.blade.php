...
<div class="container">
    ...
    <hr>
    <a href="{{ route('taxation.report') }}" class="btn btn-primary" target="_blank"><i class="fas fa-file"></i> 「兼課教師」報表產生器</a>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped">
                ...
                @foreach($ori_subs as $ori_sub)
                    <?php
                    $sub_teacher = \APP\User::where('id',$ori_sub->ori_teacher)->first();
                    ?>
                    <tr>
                        <td>
                            {{ $sub_teacher->name }}
                        ...
                        <td>
                            {{ $ori_sub->section }} <a href="{{ route('taxation.show',$ori_sub->id) }}" class="btn btn-info btn-sm"  target="_blank">詳細</a>
                        </td>
                        <td>
                            <a href="{{ route('taxation.delete',$ori_sub->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('當真要刪？')">刪除</a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
            ...
            <table class="table table-striped">
                ...
                {{ Form::open(['route'=>'taxation.store','method'=>'POST']) }}
                <tbody>
                <tr>
                    <td>
                ...
                <input type="hidden" name="type" value="taxation">
