...
class SchoolPlanController extends Controller
{
    ...
    public function index($path=null)
    {
        ...
        return view('school_plans.index',$data);
    }
    ...
    public function create()
    {
        ...
        //新增使用者的上傳目錄
        $folder = 'school_plans/'.auth()->user()->job_title;
        if(!is_dir(storage_path('app/public/school_plans'))) mkdir(storage_path('app/public/school_plans'));
        ...
        Upload::create($att);
        return redirect()->route('school_plans.index');
    }
    ...
    public function create_folder(Request $request)
    {
        ...
        //新增使用者的上傳目錄
        $new_path = 'app/public/school_plans';
        //新增目錄
    ...
    public function delete($path)
    {
        ...
        return redirect()->route('school_plans.index',$new_path);
    }
