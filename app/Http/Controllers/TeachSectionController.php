...
class TeachSectionController extends Controller
{
    ...
    public function taxation()
    {
        ...
        return view('teach_sections.taxation',$data);
    }

    public function taxation_store(Request $request)
    {
        $att['semester'] = $request->input('semester');
        $att['type'] = $request->input('type');
        $att['sub_teacher'] = $request->input('sub_teacher');
    ...
    public function taxation_show(OriSub $ori_sub)
    {
        $data = [
            'ori_sub'=>$ori_sub,
        ];

        return view('teach_sections.taxation_show',$data);
    }

    public function taxation_delete(OriSub $ori_sub)
    {
        $ori_sub->delete();
        return redirect()->route('taxation.index');
    }
    ...
    public function taxation_report()
    {
        $semester= get_semester();
        $data = [
            'semester'=>$semester
        ];
        return view('teach_sections.taxation_report1',$data);
    }

    public function taxation_send_report(Request $request)
    {
        $semester= get_semester();
        $start_date = $request->input('start_date');
        $stop_date = $request->input('stop_date');
        ...
        return view('teach_sections.taxation_report2',$data);
    }

    public function taxation_print(Request $request)
    {
        $title = $request->input('title');
        ...
        $ori_money = $request->input('ori_money');
        $laubo = $request->input('laubo');
        $zenbom = $request->input('zenbom');
        $zenbo = $request->input('zenbo');
        $laute = $request->input('laute');
        $zenbo2 = $request->input('zenbo2');
        $real_money = $request->input('real_money');
        $ps = $request->input('ps');
        ...
        return view('teach_sections.taxation_print',$data);
    }
